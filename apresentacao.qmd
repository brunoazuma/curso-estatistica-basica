...
fig = px.bar(df_counts, x='Aproveitamento', y='Número de alunos', title='Número de alunos por Aproveitamento', category_orders={'Aproveitamento': order})

# Atualize o layout: fundo branco e linhas horizontais de grade com cor rgb(229,236,246)
fig.update_layout(
    plot_bgcolor='white',
    paper_bgcolor='white'
)
fig.update_yaxes(showgrid=True, gridcolor='rgb(229,236,246)')
fig.show()
```
